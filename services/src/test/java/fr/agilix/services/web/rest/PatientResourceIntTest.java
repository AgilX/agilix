...
public class PatientResourceIntTest {
    ...
    private static final String DEFAULT_PATHOLOGY = "AAAAAAAAAA";
    private static final String UPDATED_PATHOLOGY = "BBBBBBBBBB";
     ...
     *
     * @see fr.agilix.services.repository.search.PatientSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPatient() throws Exception {
        ...
        assertThat(testPatient.getPathology()).isEqualTo(DEFAULT_PATHOLOGY);
    ...
    public void getAllPatients() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pathology").value(hasItem(DEFAULT_PATHOLOGY.toString())))
    ...
    public void getPatient() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients/{id}", patient.getId()))
            ...
            .andExpect(jsonPath("$.pathology").value(DEFAULT_PATHOLOGY.toString()))
    ...
    public void updatePatient() throws Exception {
        ...
        assertThat(testPatient.getPathology()).isEqualTo(UPDATED_PATHOLOGY);
